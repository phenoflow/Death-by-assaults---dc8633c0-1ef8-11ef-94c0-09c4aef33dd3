...
(async () => {
  ...
  await fs.writeFile("death-by-assaults-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("death-by-assaults-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
